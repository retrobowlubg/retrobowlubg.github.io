...
function loadMainGame(){
  document.querySelector('.game-frame').innerHTML = `<iframe src="${document.querySelector('.game-frame').dataset.url}" id="gameframe" frameborder="0" style="height: 500px;width: 350px;"></iframe>`;
}
function playGame(){
  document.querySelector(".game-frame").innerHTML = `<iframe src="${document.querySelector('#talpa-splash-button').dataset.url}" id="gameframe" frameborder="0" style="height: 500px; width: 350px;"></iframe>`;
}
